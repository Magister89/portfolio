...
const About = () => {
    ...
    return (
        <section id="about" className="py-20 px-6 bg-surface dark:bg-surface-dark transition-colors duration-300">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                <div className="col-span-1 md:col-span-2 max-w-2xl">
                    ...
                    <div className="mt-6 flex items-center gap-2">
                        <p className="text-lg font-medium italic text-purple-600 dark:text-purple-400">
                            {t.about.p4}
                        </p>
